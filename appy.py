        ...
        if doc_chunk:
            ...
            if suggestions:
                ...
                response = (
                    ...
                    "EDSIP, registration, and community (and any PDF you upload). For anything outside "
                    "that, please reach our team at **hello@enchanteddigitalacademy.com.ng** or WhatsApp "
                    "**+234 706 586 2449**, and they'll be happy to help."
                )
